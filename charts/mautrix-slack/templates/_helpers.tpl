{{- define "mautrix-slack.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mautrix-slack.fullname" -}}
...
{{- define "mautrix-slack.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mautrix-slack.selectorLabels" -}}
app.kubernetes.io/name: {{ include "mautrix-slack.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app: {{ include "mautrix-slack.name" . }}
{{- end -}}

{{- define "mautrix-slack.componentSelectorLabels" -}}
{{ include "mautrix-slack.selectorLabels" .context }}
app.kubernetes.io/component: {{ .component }}
{{- end -}}

{{- define "mautrix-slack.labels" -}}
helm.sh/chart: {{ include "mautrix-slack.chart" . }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "mautrix-slack.selectorLabels" . }}
{{- end -}}

{{- define "mautrix-slack.componentLabels" -}}
{{ include "mautrix-slack.labels" .context }}
app.kubernetes.io/component: {{ .component }}
{{- end -}}

{{- define "mautrix-slack.image" -}}
{{- if .Values.image.tag -}}
...
{{- define "mautrix-slack.postgresImage" -}}
...
{{- define "mautrix-slack.configSecretName" -}}
{{- printf "%s-config" (include "mautrix-slack.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mautrix-slack.registrationConfigMapName" -}}
{{- if .Values.registration.synapseConfigMapName -}}
{{- .Values.registration.synapseConfigMapName | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-registration" (include "mautrix-slack.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
...
{{- define "mautrix-slack.homeserverDomain" -}}
{{- required "values.homeserver.domain is required (example: matrix.example.com)" .Values.homeserver.domain -}}
{{- end -}}

{{- define "mautrix-slack.postgresFullname" -}}
{{- printf "%s-postgres" (include "mautrix-slack.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mautrix-slack.databaseConnectionString" -}}
{{- if .Values.database.connectionString -}}
{{- .Values.database.connectionString -}}
{{- else if .Values.postgres.enabled -}}
{{- printf "postgres://%s:%s@%s:%v/%s" .Values.database.user .Values.database.password (include "mautrix-slack.postgresFullname" .) .Values.postgres.service.port .Values.database.name -}}
{{- else -}}
{{- required "values.database.connectionString is required when postgres.enabled=false" .Values.database.connectionString -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-slack.appserviceAddress" -}}
{{- if .Values.appservice.address -}}
{{- .Values.appservice.address -}}
{{- else -}}
{{- printf "http://%s.%s.svc.cluster.local:%v" (include "mautrix-slack.fullname" .) .Release.Namespace .Values.service.port -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-slack.registrationServiceUrl" -}}
{{- if .Values.registration.serviceUrl -}}
{{- .Values.registration.serviceUrl -}}
{{- else -}}
{{- include "mautrix-slack.appserviceAddress" . -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-slack.runtimeSecretName" -}}
...
{{- else -}}
{{- printf "%s-runtime-secrets" (include "mautrix-slack.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-slack.ensureRuntimeSecrets" -}}
...
{{- $secretName := include "mautrix-slack.runtimeSecretName" . -}}
...
{{- define "mautrix-slack.registrationAsToken" -}}
{{- include "mautrix-slack.ensureRuntimeSecrets" . -}}
{{- index (index .Values.registration "_computedRuntimeSecrets") "asToken" -}}
{{- end -}}

{{- define "mautrix-slack.registrationHsToken" -}}
{{- include "mautrix-slack.ensureRuntimeSecrets" . -}}
{{- index (index .Values.registration "_computedRuntimeSecrets") "hsToken" -}}
{{- end -}}

{{- define "mautrix-slack.provisioningSharedSecret" -}}
{{- include "mautrix-slack.ensureRuntimeSecrets" . -}}
{{- index (index .Values.registration "_computedRuntimeSecrets") "provisioningSharedSecret" -}}
{{- end -}}

{{- define "mautrix-slack.registrationSenderLocalpart" -}}
...
{{- define "mautrix-slack.renderTemplateRegex" -}}
{{- $template := .template -}}
{{- $field := .field -}}
{{- $normalized := include "mautrix-slack.normalizeBridgeTemplate" (dict "template" $template "field" $field "legacyReplacement" "{placeholder}") -}}
{{- regexReplaceAll "\\{[A-Za-z_][A-Za-z0-9_]*\\}" $normalized ".*" -}}
{{- end -}}

{{- define "mautrix-slack.normalizeBridgeTemplate" -}}
{{- $template := .template -}}
{{- $field := .field -}}
...
{{- define "mautrix-slack.registrationUserRegex" -}}
{{- if .Values.registration.userRegex -}}
{{- .Values.registration.userRegex -}}
{{- else -}}
{{- printf "@%s:%s" (include "mautrix-slack.renderTemplateRegex" (dict "template" .Values.bridge.usernameTemplate "field" "bridge.usernameTemplate")) (include "mautrix-slack.homeserverDomain" .) -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-slack.registrationAliasRegex" -}}
{{- if .Values.registration.aliasRegex -}}
{{- .Values.registration.aliasRegex -}}
{{- else -}}
{{- printf "#%s:%s" (include "mautrix-slack.renderTemplateRegex" (dict "template" .Values.bridge.aliasTemplate "field" "bridge.aliasTemplate")) (include "mautrix-slack.homeserverDomain" .) -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-slack.registrationConfig" -}}
id: {{ .Values.appservice.id | quote }}
url: {{ include "mautrix-slack.registrationServiceUrl" . | quote }}
as_token: {{ include "mautrix-slack.registrationAsToken" . | quote }}
hs_token: {{ include "mautrix-slack.registrationHsToken" . | quote }}
sender_localpart: {{ include "mautrix-slack.registrationSenderLocalpart" . | quote }}
rate_limited: {{ .Values.registration.rateLimited }}
de.sorunome.msc2409.push_ephemeral: {{ .Values.appservice.ephemeralEvents }}
namespaces:
  users:
    - exclusive: true
      regex: {{ include "mautrix-slack.registrationUserRegex" . | squote }}
  aliases:
    - exclusive: true
      regex: {{ include "mautrix-slack.registrationAliasRegex" . | squote }}
{{- end -}}
