{{- define "mautrix-linkedin.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mautrix-linkedin.fullname" -}}
...
{{- define "mautrix-linkedin.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mautrix-linkedin.selectorLabels" -}}
app.kubernetes.io/name: {{ include "mautrix-linkedin.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app: {{ include "mautrix-linkedin.name" . }}
{{- end -}}

{{- define "mautrix-linkedin.componentSelectorLabels" -}}
{{ include "mautrix-linkedin.selectorLabels" .context }}
app.kubernetes.io/component: {{ .component }}
{{- end -}}

{{- define "mautrix-linkedin.labels" -}}
helm.sh/chart: {{ include "mautrix-linkedin.chart" . }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "mautrix-linkedin.selectorLabels" . }}
{{- end -}}

{{- define "mautrix-linkedin.componentLabels" -}}
{{ include "mautrix-linkedin.labels" .context }}
app.kubernetes.io/component: {{ .component }}
{{- end -}}

{{- define "mautrix-linkedin.image" -}}
{{- if .Values.image.tag -}}
...
{{- define "mautrix-linkedin.postgresImage" -}}
...
{{- define "mautrix-linkedin.configSecretName" -}}
{{- printf "%s-config" (include "mautrix-linkedin.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mautrix-linkedin.registrationConfigMapName" -}}
{{- if .Values.registration.synapseConfigMapName -}}
{{- .Values.registration.synapseConfigMapName | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-registration" (include "mautrix-linkedin.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
...
{{- define "mautrix-linkedin.homeserverDomain" -}}
{{- required "values.homeserver.domain is required (example: matrix.example.com)" .Values.homeserver.domain -}}
{{- end -}}

{{- define "mautrix-linkedin.postgresFullname" -}}
{{- printf "%s-postgres" (include "mautrix-linkedin.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "mautrix-linkedin.databaseConnectionString" -}}
{{- if .Values.database.connectionString -}}
{{- .Values.database.connectionString -}}
{{- else if .Values.postgres.enabled -}}
{{- printf "postgres://%s:%s@%s:%v/%s" .Values.database.user .Values.database.password (include "mautrix-linkedin.postgresFullname" .) .Values.postgres.service.port .Values.database.name -}}
{{- else -}}
{{- required "values.database.connectionString is required when postgres.enabled=false" .Values.database.connectionString -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-linkedin.appserviceAddress" -}}
{{- if .Values.appservice.address -}}
{{- .Values.appservice.address -}}
{{- else -}}
{{- printf "http://%s.%s.svc.cluster.local:%v" (include "mautrix-linkedin.fullname" .) .Release.Namespace .Values.service.port -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-linkedin.registrationServiceUrl" -}}
{{- if .Values.registration.serviceUrl -}}
{{- .Values.registration.serviceUrl -}}
{{- else -}}
{{- include "mautrix-linkedin.appserviceAddress" . -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-linkedin.runtimeSecretName" -}}
...
{{- else -}}
{{- printf "%s-runtime-secrets" (include "mautrix-linkedin.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-linkedin.ensureRuntimeSecrets" -}}
...
{{- $secretName := include "mautrix-linkedin.runtimeSecretName" . -}}
...
{{- define "mautrix-linkedin.registrationAsToken" -}}
{{- include "mautrix-linkedin.ensureRuntimeSecrets" . -}}
{{- index (index .Values.registration "_computedRuntimeSecrets") "asToken" -}}
{{- end -}}

{{- define "mautrix-linkedin.registrationHsToken" -}}
{{- include "mautrix-linkedin.ensureRuntimeSecrets" . -}}
{{- index (index .Values.registration "_computedRuntimeSecrets") "hsToken" -}}
{{- end -}}

{{- define "mautrix-linkedin.provisioningSharedSecret" -}}
{{- include "mautrix-linkedin.ensureRuntimeSecrets" . -}}
{{- index (index .Values.registration "_computedRuntimeSecrets") "provisioningSharedSecret" -}}
{{- end -}}

{{- define "mautrix-linkedin.registrationSenderLocalpart" -}}
...
{{- define "mautrix-linkedin.renderTemplateRegex" -}}
{{- $template := .template -}}
{{- $field := .field -}}
{{- $normalized := include "mautrix-linkedin.normalizeBridgeTemplate" (dict "template" $template "field" $field "legacyReplacement" "{placeholder}") -}}
{{- regexReplaceAll "\\{[A-Za-z_][A-Za-z0-9_]*\\}" $normalized ".*" -}}
{{- end -}}

{{- define "mautrix-linkedin.normalizeBridgeTemplate" -}}
{{- $template := .template -}}
{{- $field := .field -}}
...
{{- define "mautrix-linkedin.registrationUserRegex" -}}
{{- if .Values.registration.userRegex -}}
{{- .Values.registration.userRegex -}}
{{- else -}}
{{- printf "@%s:%s" (include "mautrix-linkedin.renderTemplateRegex" (dict "template" .Values.bridge.usernameTemplate "field" "bridge.usernameTemplate")) (include "mautrix-linkedin.homeserverDomain" .) -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-linkedin.registrationAliasRegex" -}}
{{- if .Values.registration.aliasRegex -}}
{{- .Values.registration.aliasRegex -}}
{{- else -}}
{{- printf "#%s:%s" (include "mautrix-linkedin.renderTemplateRegex" (dict "template" .Values.bridge.aliasTemplate "field" "bridge.aliasTemplate")) (include "mautrix-linkedin.homeserverDomain" .) -}}
{{- end -}}
{{- end -}}

{{- define "mautrix-linkedin.registrationConfig" -}}
id: {{ .Values.appservice.id | quote }}
url: {{ include "mautrix-linkedin.registrationServiceUrl" . | quote }}
as_token: {{ include "mautrix-linkedin.registrationAsToken" . | quote }}
hs_token: {{ include "mautrix-linkedin.registrationHsToken" . | quote }}
sender_localpart: {{ include "mautrix-linkedin.registrationSenderLocalpart" . | quote }}
rate_limited: {{ .Values.registration.rateLimited }}
de.sorunome.msc2409.push_ephemeral: {{ .Values.appservice.ephemeralEvents }}
namespaces:
  users:
    - exclusive: true
      regex: {{ include "mautrix-linkedin.registrationUserRegex" . | squote }}
  aliases:
    - exclusive: true
      regex: {{ include "mautrix-linkedin.registrationAliasRegex" . | squote }}
{{- end -}}
