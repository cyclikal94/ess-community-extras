...
{{- printf "postgres://%s:%s@%s:%v/%s" .Values.database.user .Values.database.password (include "mautrix-googlechat.postgresFullname" .) .Values.postgres.service.port .Values.database.name -}}
{{- else -}}
